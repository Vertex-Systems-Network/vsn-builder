...
async function callProvider({ execution, behavior, prompt, currentDocument, meta, commerceContext }) {
  ...
  return { result: normalizeAiResult(provider.output, currentDocument), ...provider };
}
