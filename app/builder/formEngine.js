...
export function normalizeFormAutomationSettings(input={}){const s=input&&typeof input==="object"?input:{};return{
  ...
  redirectUrl:text(s.redirectUrl,1500),
...
export function formSuccessPayload(settings){return{type:settings.successAction,message:settings.successMessage,redirectUrl:settings.redirectUrl,eventName:settings.customEventName,couponCode:settings.couponCode}}
