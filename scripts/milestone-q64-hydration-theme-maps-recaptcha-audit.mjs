...
await check("No Q6.4 Prisma migration was added",()=>assert.equal(fs.readdirSync("prisma/migrations").some((name)=>/q64|hydration_theme|google_maps|recaptcha/i.test(name)),false));
